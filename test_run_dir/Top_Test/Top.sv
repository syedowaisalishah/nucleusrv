...
module ImmediateGen(
  ...
  wire [31:0] _ext_u_T_2 = imm_u[19] ? 32'hffffffff : 32'h0; // @[Bitwise.scala 77:12]
  wire [63:0] ext_u = {_ext_u_T_2,imm_u,12'h0}; // @[Cat.scala 33:92]
  ...
  wire [63:0] _GEN_2 = opcode == 7'h17 | opcode == 7'h37 ? ext_u : _GEN_1; // @[ImmediateGen.scala 23:49 26:12]
...
module InstructionDecode(
  ...
  wire  bu_io_branch; // @[InstructionDecode.scala 191:18]
  wire [2:0] bu_io_funct3; // @[InstructionDecode.scala 191:18]
  wire [63:0] bu_io_rd1; // @[InstructionDecode.scala 191:18]
  wire [63:0] bu_io_rd2; // @[InstructionDecode.scala 191:18]
  wire  bu_io_take_branch; // @[InstructionDecode.scala 191:18]
  wire  bu_io_taken; // @[InstructionDecode.scala 191:18]
  ...
  wire [63:0] _GEN_6 = io_id_instruction[19:15] == io_mem_wb_ins[11:7] ? io_mem_wb_result : io_readData1; // @[InstructionDecode.scala 176:52 177:12 179:12]
  wire [63:0] input1 = io_id_instruction[19:15] == io_ex_mem_ins[11:7] ? io_ex_mem_result : _GEN_6; // @[InstructionDecode.scala 174:46 175:12]
  wire [63:0] _GEN_8 = io_id_instruction[24:20] == io_mem_wb_ins[11:7] ? io_mem_wb_result : io_readData2; // @[InstructionDecode.scala 184:52 185:12 187:12]
  wire [63:0] j_offset = io_id_instruction[19:15] == io_ex_ins[11:7] ? io_ex_result : input1; // @[InstructionDecode.scala 201:42 202:14]
  wire [31:0] _io_pcPlusOffset_T_2 = io_pcAddress + io_immediate[31:0]; // @[InstructionDecode.scala 213:37]
  wire [31:0] _io_pcPlusOffset_T_6 = j_offset[31:0] + io_immediate[31:0]; // @[InstructionDecode.scala 215:39]
  wire [31:0] _io_pcPlusOffset_T_9 = io_pcAddress + immediate_io_out[31:0]; // @[InstructionDecode.scala 217:37]
  wire [31:0] _GEN_13 = io_ctl_jump == 2'h2 ? _io_pcPlusOffset_T_6 : _io_pcPlusOffset_T_9; // @[InstructionDecode.scala 214:35 215:21 217:21]
  wire [63:0] _T_33 = io_ex_mem_mem_read ? io_dmem_data : io_ex_mem_result; // @[InstructionDecode.scala 241:15]
  ...
  BranchUnit bu ( // @[InstructionDecode.scala 191:18]
  ...
  assign io_immediate = immediate_io_out; // @[InstructionDecode.scala 168:16]
  assign io_writeRegAddress = io_id_instruction[11:7]; // @[InstructionDecode.scala 229:42]
  ...
  assign io_func7 = io_id_instruction[6:0] == 7'h33 | io_id_instruction[6:0] == 7'h13 & io_func3 == 3'h5 ?
    io_id_instruction[31:25] : 7'h0; // @[InstructionDecode.scala 231:120 232:14 234:14]
  assign io_func3 = io_id_instruction[14:12]; // @[InstructionDecode.scala 230:32]
  ...
  assign io_pcSrc = bu_io_taken | io_ctl_jump != 2'h0; // @[InstructionDecode.scala 220:20]
  assign io_pcPlusOffset = io_ctl_jump == 2'h1 ? _io_pcPlusOffset_T_2 : _GEN_13; // @[InstructionDecode.scala 212:29 213:21]
  assign io_ifid_flush = hdu_io_ifid_flush; // @[InstructionDecode.scala 227:17]
  ...
  assign csr_io_i_data = _csr_io_i_data_T_11[31:0]; // @[InstructionDecode.scala 248:17]
  ...
  assign hdu_io_taken = bu_io_taken; // @[InstructionDecode.scala 197:16]
  ...
  assign bu_io_branch = io_ctl_branch; // @[InstructionDecode.scala 192:16]
  assign bu_io_funct3 = io_id_instruction[14:12]; // @[InstructionDecode.scala 193:36]
  assign bu_io_rd1 = io_id_instruction[19:15] == io_ex_mem_ins[11:7] ? io_ex_mem_result : _GEN_6; // @[InstructionDecode.scala 174:46 175:12]
  assign bu_io_rd2 = io_id_instruction[24:20] == io_ex_mem_ins[11:7] ? io_ex_mem_result : _GEN_8; // @[InstructionDecode.scala 182:46 183:12]
  assign bu_io_take_branch = hdu_io_take_branch; // @[InstructionDecode.scala 196:21]
endmodule
module ALU(
  ...
  wire [63:0] _io_result_T_11 = io_input1; // @[ALU.scala 25:41]
  ...
  wire [63:0] _io_result_T_28 = $signed(io_input1) >>> io_input2[5:0]; // @[ALU.scala 29:68]
  wire  _io_result_T_29 = io_aluCtl == 4'h9; // @[ALU.scala 30:18]
  wire [63:0] _io_result_T_30 = io_input1 ^ io_input2; // @[ALU.scala 30:41]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_1;
`endif // RANDOMIZE_REG_INIT
  reg [2:0] offset; // @[MemoryFetch.scala 306:23]
  reg [2:0] funct3; // @[MemoryFetch.scala 307:23]
  wire [2:0] offsetSW = io_aluResultIn[2:0]; // @[MemoryFetch.scala 308:32]
  wire  _T_3 = offsetSW == 3'h0; // @[MemoryFetch.scala 333:18]
  wire  _T_4 = offsetSW == 3'h1; // @[MemoryFetch.scala 335:23]
  wire  _T_5 = offsetSW == 3'h2; // @[MemoryFetch.scala 341:23]
  wire  _T_6 = offsetSW == 3'h3; // @[MemoryFetch.scala 347:23]
  wire  _T_7 = offsetSW == 3'h4; // @[MemoryFetch.scala 353:23]
  wire  _T_8 = offsetSW == 3'h5; // @[MemoryFetch.scala 360:23]
  wire  _T_9 = offsetSW == 3'h6; // @[MemoryFetch.scala 367:23]
  wire [7:0] _GEN_2 = offsetSW == 3'h7 ? io_writeData[15:8] : io_writeData[7:0]; // @[MemoryFetch.scala 320:10 374:31 375:14]
  wire [7:0] _GEN_3 = offsetSW == 3'h7 ? io_writeData[23:16] : io_writeData[15:8]; // @[MemoryFetch.scala 321:10 374:31 376:14]
  wire [7:0] _GEN_4 = offsetSW == 3'h7 ? io_writeData[31:24] : io_writeData[23:16]; // @[MemoryFetch.scala 322:10 374:31 377:14]
  wire [7:0] _GEN_5 = offsetSW == 3'h7 ? io_writeData[63:56] : io_writeData[31:24]; // @[MemoryFetch.scala 323:10 374:31 378:14]
  wire [7:0] _GEN_6 = offsetSW == 3'h7 ? io_writeData[7:0] : io_writeData[63:56]; // @[MemoryFetch.scala 327:10 374:31 379:14]
  wire [7:0] _GEN_7 = offsetSW == 3'h7 ? 8'h80 : 8'h0; // @[MemoryFetch.scala 374:31 328:32 380:36]
  wire [7:0] _GEN_8 = offsetSW == 3'h6 ? io_writeData[15:8] : _GEN_2; // @[MemoryFetch.scala 367:31 368:14]
  wire [7:0] _GEN_9 = offsetSW == 3'h6 ? io_writeData[23:16] : _GEN_3; // @[MemoryFetch.scala 367:31 369:14]
  wire [7:0] _GEN_10 = offsetSW == 3'h6 ? io_writeData[31:24] : _GEN_4; // @[MemoryFetch.scala 367:31 370:14]
  wire [7:0] _GEN_11 = offsetSW == 3'h6 ? io_writeData[55:48] : _GEN_5; // @[MemoryFetch.scala 367:31 371:14]
  wire [7:0] _GEN_12 = offsetSW == 3'h6 ? io_writeData[7:0] : io_writeData[55:48]; // @[MemoryFetch.scala 326:10 367:31 372:14]
  wire [7:0] _GEN_13 = offsetSW == 3'h6 ? 8'h40 : _GEN_7; // @[MemoryFetch.scala 367:31 373:36]
  wire [7:0] _GEN_14 = offsetSW == 3'h6 ? io_writeData[63:56] : _GEN_6; // @[MemoryFetch.scala 327:10 367:31]
  wire [7:0] _GEN_15 = offsetSW == 3'h5 ? io_writeData[15:8] : _GEN_8; // @[MemoryFetch.scala 360:31 361:14]
  wire [7:0] _GEN_16 = offsetSW == 3'h5 ? io_writeData[23:16] : _GEN_9; // @[MemoryFetch.scala 360:31 362:14]
  wire [7:0] _GEN_17 = offsetSW == 3'h5 ? io_writeData[31:24] : _GEN_10; // @[MemoryFetch.scala 360:31 363:14]
  wire [7:0] _GEN_18 = offsetSW == 3'h5 ? io_writeData[47:40] : _GEN_11; // @[MemoryFetch.scala 360:31 364:14]
  wire [7:0] _GEN_19 = offsetSW == 3'h5 ? io_writeData[7:0] : io_writeData[47:40]; // @[MemoryFetch.scala 325:10 360:31 365:14]
  wire [7:0] _GEN_20 = offsetSW == 3'h5 ? 8'h20 : _GEN_13; // @[MemoryFetch.scala 360:31 366:36]
  wire [7:0] _GEN_21 = offsetSW == 3'h5 ? io_writeData[55:48] : _GEN_12; // @[MemoryFetch.scala 326:10 360:31]
  wire [7:0] _GEN_22 = offsetSW == 3'h5 ? io_writeData[63:56] : _GEN_14; // @[MemoryFetch.scala 327:10 360:31]
  wire [7:0] _GEN_23 = offsetSW == 3'h4 ? io_writeData[15:8] : _GEN_15; // @[MemoryFetch.scala 353:31 354:14]
  wire [7:0] _GEN_24 = offsetSW == 3'h4 ? io_writeData[23:16] : _GEN_16; // @[MemoryFetch.scala 353:31 355:14]
  wire [7:0] _GEN_25 = offsetSW == 3'h4 ? io_writeData[31:24] : _GEN_17; // @[MemoryFetch.scala 353:31 356:14]
  wire [7:0] _GEN_26 = offsetSW == 3'h4 ? io_writeData[39:32] : _GEN_18; // @[MemoryFetch.scala 353:31 357:14]
  wire [7:0] _GEN_27 = offsetSW == 3'h4 ? io_writeData[7:0] : io_writeData[39:32]; // @[MemoryFetch.scala 324:10 353:31 358:14]
  wire [7:0] _GEN_28 = offsetSW == 3'h4 ? 8'h10 : _GEN_20; // @[MemoryFetch.scala 353:31 359:36]
  wire [7:0] _GEN_29 = offsetSW == 3'h4 ? io_writeData[47:40] : _GEN_19; // @[MemoryFetch.scala 325:10 353:31]
  wire [7:0] _GEN_30 = offsetSW == 3'h4 ? io_writeData[55:48] : _GEN_21; // @[MemoryFetch.scala 326:10 353:31]
  wire [7:0] _GEN_31 = offsetSW == 3'h4 ? io_writeData[63:56] : _GEN_22; // @[MemoryFetch.scala 327:10 353:31]
  wire [7:0] _GEN_32 = offsetSW == 3'h3 ? io_writeData[15:8] : _GEN_23; // @[MemoryFetch.scala 347:31 348:14]
  wire [7:0] _GEN_33 = offsetSW == 3'h3 ? io_writeData[23:16] : _GEN_24; // @[MemoryFetch.scala 347:31 349:14]
  wire [7:0] _GEN_34 = offsetSW == 3'h3 ? io_writeData[31:24] : _GEN_25; // @[MemoryFetch.scala 347:31 350:14]
  wire [7:0] _GEN_35 = offsetSW == 3'h3 ? io_writeData[7:0] : _GEN_26; // @[MemoryFetch.scala 347:31 351:14]
  wire [7:0] _GEN_36 = offsetSW == 3'h3 ? 8'h8 : _GEN_28; // @[MemoryFetch.scala 347:31 352:36]
  wire [7:0] _GEN_37 = offsetSW == 3'h3 ? io_writeData[39:32] : _GEN_27; // @[MemoryFetch.scala 324:10 347:31]
  wire [7:0] _GEN_38 = offsetSW == 3'h3 ? io_writeData[47:40] : _GEN_29; // @[MemoryFetch.scala 325:10 347:31]
  wire [7:0] _GEN_39 = offsetSW == 3'h3 ? io_writeData[55:48] : _GEN_30; // @[MemoryFetch.scala 326:10 347:31]
  wire [7:0] _GEN_40 = offsetSW == 3'h3 ? io_writeData[63:56] : _GEN_31; // @[MemoryFetch.scala 327:10 347:31]
  wire [7:0] _GEN_41 = offsetSW == 3'h2 ? io_writeData[15:8] : _GEN_32; // @[MemoryFetch.scala 341:31 342:14]
  wire [7:0] _GEN_42 = offsetSW == 3'h2 ? io_writeData[23:16] : _GEN_33; // @[MemoryFetch.scala 341:31 343:14]
  wire [7:0] _GEN_43 = offsetSW == 3'h2 ? io_writeData[7:0] : _GEN_34; // @[MemoryFetch.scala 341:31 344:14]
  wire [7:0] _GEN_44 = offsetSW == 3'h2 ? io_writeData[31:24] : _GEN_35; // @[MemoryFetch.scala 341:31 345:14]
  wire [7:0] _GEN_45 = offsetSW == 3'h2 ? 8'h4 : _GEN_36; // @[MemoryFetch.scala 341:31 346:36]
  wire [7:0] _GEN_46 = offsetSW == 3'h2 ? io_writeData[39:32] : _GEN_37; // @[MemoryFetch.scala 324:10 341:31]
  wire [7:0] _GEN_47 = offsetSW == 3'h2 ? io_writeData[47:40] : _GEN_38; // @[MemoryFetch.scala 325:10 341:31]
  wire [7:0] _GEN_48 = offsetSW == 3'h2 ? io_writeData[55:48] : _GEN_39; // @[MemoryFetch.scala 326:10 341:31]
  wire [7:0] _GEN_49 = offsetSW == 3'h2 ? io_writeData[63:56] : _GEN_40; // @[MemoryFetch.scala 327:10 341:31]
  wire [7:0] _GEN_50 = offsetSW == 3'h1 ? io_writeData[15:8] : _GEN_41; // @[MemoryFetch.scala 335:31 336:14]
  wire [7:0] _GEN_51 = offsetSW == 3'h1 ? io_writeData[7:0] : _GEN_42; // @[MemoryFetch.scala 335:31 337:14]
  wire [7:0] _GEN_52 = offsetSW == 3'h1 ? io_writeData[23:16] : _GEN_43; // @[MemoryFetch.scala 335:31 338:14]
  wire [7:0] _GEN_53 = offsetSW == 3'h1 ? io_writeData[31:24] : _GEN_44; // @[MemoryFetch.scala 335:31 339:14]
  wire [7:0] _GEN_54 = offsetSW == 3'h1 ? 8'h2 : _GEN_45; // @[MemoryFetch.scala 335:31 340:36]
  wire [7:0] _GEN_55 = offsetSW == 3'h1 ? io_writeData[39:32] : _GEN_46; // @[MemoryFetch.scala 324:10 335:31]
  wire [7:0] _GEN_56 = offsetSW == 3'h1 ? io_writeData[47:40] : _GEN_47; // @[MemoryFetch.scala 325:10 335:31]
  wire [7:0] _GEN_57 = offsetSW == 3'h1 ? io_writeData[55:48] : _GEN_48; // @[MemoryFetch.scala 326:10 335:31]
  wire [7:0] _GEN_58 = offsetSW == 3'h1 ? io_writeData[63:56] : _GEN_49; // @[MemoryFetch.scala 327:10 335:31]
  wire [7:0] _GEN_59 = offsetSW == 3'h0 ? 8'h1 : _GEN_54; // @[MemoryFetch.scala 333:26 334:36]
  wire [7:0] _GEN_60 = offsetSW == 3'h0 ? io_writeData[7:0] : _GEN_50; // @[MemoryFetch.scala 320:10 333:26]
  wire [7:0] _GEN_61 = offsetSW == 3'h0 ? io_writeData[15:8] : _GEN_51; // @[MemoryFetch.scala 321:10 333:26]
  wire [7:0] _GEN_62 = offsetSW == 3'h0 ? io_writeData[23:16] : _GEN_52; // @[MemoryFetch.scala 322:10 333:26]
  wire [7:0] _GEN_63 = offsetSW == 3'h0 ? io_writeData[31:24] : _GEN_53; // @[MemoryFetch.scala 323:10 333:26]
  wire [7:0] _GEN_64 = offsetSW == 3'h0 ? io_writeData[39:32] : _GEN_55; // @[MemoryFetch.scala 324:10 333:26]
  wire [7:0] _GEN_65 = offsetSW == 3'h0 ? io_writeData[47:40] : _GEN_56; // @[MemoryFetch.scala 325:10 333:26]
  wire [7:0] _GEN_66 = offsetSW == 3'h0 ? io_writeData[55:48] : _GEN_57; // @[MemoryFetch.scala 326:10 333:26]
  wire [7:0] _GEN_67 = offsetSW == 3'h0 ? io_writeData[63:56] : _GEN_58; // @[MemoryFetch.scala 327:10 333:26]
  wire [7:0] _GEN_68 = _T_9 ? 8'hc0 : 8'h0; // @[MemoryFetch.scala 328:32 414:32 416:36]
  wire [7:0] _GEN_70 = _T_9 ? io_writeData[15:8] : io_writeData[63:56]; // @[MemoryFetch.scala 327:10 414:32 418:14]
  wire [7:0] _GEN_71 = _T_8 ? 8'h60 : _GEN_68; // @[MemoryFetch.scala 409:32 411:36]
  wire [7:0] _GEN_73 = _T_8 ? io_writeData[15:8] : _GEN_12; // @[MemoryFetch.scala 409:32 413:14]
  wire [7:0] _GEN_74 = _T_8 ? io_writeData[63:56] : _GEN_70; // @[MemoryFetch.scala 327:10 409:32]
  wire [7:0] _GEN_75 = _T_7 ? 8'h30 : _GEN_71; // @[MemoryFetch.scala 404:32 406:36]
  wire [7:0] _GEN_77 = _T_7 ? io_writeData[15:8] : _GEN_19; // @[MemoryFetch.scala 404:32 408:14]
  wire [7:0] _GEN_78 = _T_7 ? io_writeData[55:48] : _GEN_73; // @[MemoryFetch.scala 326:10 404:32]
  wire [7:0] _GEN_79 = _T_7 ? io_writeData[63:56] : _GEN_74; // @[MemoryFetch.scala 327:10 404:32]
  wire [7:0] _GEN_80 = _T_6 ? 8'h18 : _GEN_75; // @[MemoryFetch.scala 399:32 401:36]
  wire [7:0] _GEN_81 = _T_6 ? io_writeData[7:0] : io_writeData[31:24]; // @[MemoryFetch.scala 323:10 399:32 402:14]
  wire [7:0] _GEN_82 = _T_6 ? io_writeData[15:8] : _GEN_27; // @[MemoryFetch.scala 399:32 403:14]
  wire [7:0] _GEN_83 = _T_6 ? io_writeData[47:40] : _GEN_77; // @[MemoryFetch.scala 325:10 399:32]
  wire [7:0] _GEN_84 = _T_6 ? io_writeData[55:48] : _GEN_78; // @[MemoryFetch.scala 326:10 399:32]
  wire [7:0] _GEN_85 = _T_6 ? io_writeData[63:56] : _GEN_79; // @[MemoryFetch.scala 327:10 399:32]
  wire [7:0] _GEN_86 = _T_5 ? 8'hc : _GEN_80; // @[MemoryFetch.scala 394:32 396:36]
  wire [7:0] _GEN_87 = _T_5 ? io_writeData[7:0] : io_writeData[23:16]; // @[MemoryFetch.scala 322:10 394:32 397:14]
  wire [7:0] _GEN_88 = _T_5 ? io_writeData[15:8] : _GEN_81; // @[MemoryFetch.scala 394:32 398:14]
  wire [7:0] _GEN_89 = _T_5 ? io_writeData[39:32] : _GEN_82; // @[MemoryFetch.scala 324:10 394:32]
  wire [7:0] _GEN_90 = _T_5 ? io_writeData[47:40] : _GEN_83; // @[MemoryFetch.scala 325:10 394:32]
  wire [7:0] _GEN_91 = _T_5 ? io_writeData[55:48] : _GEN_84; // @[MemoryFetch.scala 326:10 394:32]
  wire [7:0] _GEN_92 = _T_5 ? io_writeData[63:56] : _GEN_85; // @[MemoryFetch.scala 327:10 394:32]
  wire [7:0] _GEN_93 = _T_4 ? 8'h6 : _GEN_86; // @[MemoryFetch.scala 389:32 391:36]
  wire [7:0] _GEN_94 = _T_4 ? io_writeData[7:0] : io_writeData[15:8]; // @[MemoryFetch.scala 321:10 389:32 392:14]
  wire [7:0] _GEN_95 = _T_4 ? io_writeData[15:8] : _GEN_87; // @[MemoryFetch.scala 389:32 393:14]
  wire [7:0] _GEN_96 = _T_4 ? io_writeData[31:24] : _GEN_88; // @[MemoryFetch.scala 323:10 389:32]
  wire [7:0] _GEN_97 = _T_4 ? io_writeData[39:32] : _GEN_89; // @[MemoryFetch.scala 324:10 389:32]
  wire [7:0] _GEN_98 = _T_4 ? io_writeData[47:40] : _GEN_90; // @[MemoryFetch.scala 325:10 389:32]
  wire [7:0] _GEN_99 = _T_4 ? io_writeData[55:48] : _GEN_91; // @[MemoryFetch.scala 326:10 389:32]
  wire [7:0] _GEN_100 = _T_4 ? io_writeData[63:56] : _GEN_92; // @[MemoryFetch.scala 327:10 389:32]
  wire [7:0] _GEN_101 = _T_3 ? 8'h3 : _GEN_93; // @[MemoryFetch.scala 384:26 386:36]
  wire [7:0] _GEN_102 = _T_3 ? io_writeData[7:0] : io_writeData[7:0]; // @[MemoryFetch.scala 320:10 384:26 387:14]
  wire [7:0] _GEN_103 = _T_3 ? io_writeData[15:8] : _GEN_94; // @[MemoryFetch.scala 384:26 388:14]
  wire [7:0] _GEN_104 = _T_3 ? io_writeData[23:16] : _GEN_95; // @[MemoryFetch.scala 322:10 384:26]
  wire [7:0] _GEN_105 = _T_3 ? io_writeData[31:24] : _GEN_96; // @[MemoryFetch.scala 323:10 384:26]
  wire [7:0] _GEN_106 = _T_3 ? io_writeData[39:32] : _GEN_97; // @[MemoryFetch.scala 324:10 384:26]
  wire [7:0] _GEN_107 = _T_3 ? io_writeData[47:40] : _GEN_98; // @[MemoryFetch.scala 325:10 384:26]
  wire [7:0] _GEN_108 = _T_3 ? io_writeData[55:48] : _GEN_99; // @[MemoryFetch.scala 326:10 384:26]
  wire [7:0] _GEN_109 = _T_3 ? io_writeData[63:56] : _GEN_100; // @[MemoryFetch.scala 327:10 384:26]
  wire [7:0] _GEN_110 = io_writeEnable & io_f3 == 3'h1 ? _GEN_101 : 8'hff; // @[MemoryFetch.scala 382:50 421:36]
  wire [7:0] _GEN_111 = io_writeEnable & io_f3 == 3'h1 ? _GEN_102 : io_writeData[7:0]; // @[MemoryFetch.scala 320:10 382:50]
  wire [7:0] _GEN_112 = io_writeEnable & io_f3 == 3'h1 ? _GEN_103 : io_writeData[15:8]; // @[MemoryFetch.scala 321:10 382:50]
  wire [7:0] _GEN_113 = io_writeEnable & io_f3 == 3'h1 ? _GEN_104 : io_writeData[23:16]; // @[MemoryFetch.scala 322:10 382:50]
  wire [7:0] _GEN_114 = io_writeEnable & io_f3 == 3'h1 ? _GEN_105 : io_writeData[31:24]; // @[MemoryFetch.scala 323:10 382:50]
  wire [7:0] _GEN_115 = io_writeEnable & io_f3 == 3'h1 ? _GEN_106 : io_writeData[39:32]; // @[MemoryFetch.scala 324:10 382:50]
  wire [7:0] _GEN_116 = io_writeEnable & io_f3 == 3'h1 ? _GEN_107 : io_writeData[47:40]; // @[MemoryFetch.scala 325:10 382:50]
  wire [7:0] _GEN_117 = io_writeEnable & io_f3 == 3'h1 ? _GEN_108 : io_writeData[55:48]; // @[MemoryFetch.scala 326:10 382:50]
  wire [7:0] _GEN_118 = io_writeEnable & io_f3 == 3'h1 ? _GEN_109 : io_writeData[63:56]; // @[MemoryFetch.scala 327:10 382:50]
  wire [7:0] wdata_0 = io_writeEnable & io_f3 == 3'h0 ? _GEN_60 : _GEN_111; // @[MemoryFetch.scala 332:45]
  wire [7:0] wdata_1 = io_writeEnable & io_f3 == 3'h0 ? _GEN_61 : _GEN_112; // @[MemoryFetch.scala 332:45]
  wire [7:0] wdata_2 = io_writeEnable & io_f3 == 3'h0 ? _GEN_62 : _GEN_113; // @[MemoryFetch.scala 332:45]
  wire [7:0] wdata_3 = io_writeEnable & io_f3 == 3'h0 ? _GEN_63 : _GEN_114; // @[MemoryFetch.scala 332:45]
  wire [7:0] wdata_4 = io_writeEnable & io_f3 == 3'h0 ? _GEN_64 : _GEN_115; // @[MemoryFetch.scala 332:45]
  wire [7:0] wdata_5 = io_writeEnable & io_f3 == 3'h0 ? _GEN_65 : _GEN_116; // @[MemoryFetch.scala 332:45]
  wire [7:0] wdata_6 = io_writeEnable & io_f3 == 3'h0 ? _GEN_66 : _GEN_117; // @[MemoryFetch.scala 332:45]
  wire [7:0] wdata_7 = io_writeEnable & io_f3 == 3'h0 ? _GEN_67 : _GEN_118; // @[MemoryFetch.scala 332:45]
  wire [31:0] io_dccmReq_bits_dataRequest_lo = {wdata_3,wdata_2,wdata_1,wdata_0}; // @[MemoryFetch.scala 423:46]
  wire [31:0] io_dccmReq_bits_dataRequest_hi = {wdata_7,wdata_6,wdata_5,wdata_4}; // @[MemoryFetch.scala 423:46]
  wire [63:0] _io_dccmReq_bits_addrRequest_T = io_aluResultIn & 64'h1fff; // @[MemoryFetch.scala 424:50]
  wire [63:0] rdata = io_dccmRsp_valid ? io_dccmRsp_bits_dataResponse : 64'h0; // @[MemoryFetch.scala 430:15]
  wire  _T_22 = offset == 3'h0; // @[MemoryFetch.scala 438:17]
  ...
  wire  _T_23 = offset == 3'h1; // @[MemoryFetch.scala 441:23]
  ...
  wire  _T_24 = offset == 3'h2; // @[MemoryFetch.scala 444:23]
  ...
  wire  _T_25 = offset == 3'h3; // @[MemoryFetch.scala 447:23]
  ...
  wire  _T_26 = offset == 3'h4; // @[MemoryFetch.scala 450:23]
  ...
  wire  _T_27 = offset == 3'h5; // @[MemoryFetch.scala 453:23]
  ...
  wire  _T_28 = offset == 3'h6; // @[MemoryFetch.scala 456:23]
  ...
  wire [63:0] _GEN_129 = offset == 3'h6 ? _io_readData_T_34 : _io_readData_T_39; // @[MemoryFetch.scala 456:37 458:19]
  wire [63:0] _GEN_130 = offset == 3'h5 ? _io_readData_T_29 : _GEN_129; // @[MemoryFetch.scala 453:37 455:19]
  wire [63:0] _GEN_131 = offset == 3'h4 ? _io_readData_T_24 : _GEN_130; // @[MemoryFetch.scala 450:37 452:19]
  wire [63:0] _GEN_132 = offset == 3'h3 ? _io_readData_T_19 : _GEN_131; // @[MemoryFetch.scala 447:37 449:19]
  wire [63:0] _GEN_133 = offset == 3'h2 ? _io_readData_T_14 : _GEN_132; // @[MemoryFetch.scala 444:37 446:19]
  wire [63:0] _GEN_134 = offset == 3'h1 ? _io_readData_T_9 : _GEN_133; // @[MemoryFetch.scala 441:37 443:19]
  wire [63:0] _GEN_135 = offset == 3'h0 ? _io_readData_T_4 : _GEN_134; // @[MemoryFetch.scala 438:31 440:19]
  wire [63:0] _GEN_136 = funct3 == 3'h0 ? _GEN_135 : 64'h0; // @[MemoryFetch.scala 431:15 436:35]
  wire [63:0] _GEN_137 = funct3 == 3'h2 ? rdata : _GEN_136; // @[MemoryFetch.scala 433:31 435:17]
  ...
  wire [63:0] _GEN_139 = _T_28 ? _io_readData_T_60 : _io_readData_T_63; // @[MemoryFetch.scala 487:35 489:17]
  wire [63:0] _GEN_140 = _T_27 ? _io_readData_T_57 : _GEN_139; // @[MemoryFetch.scala 484:35 486:17]
  wire [63:0] _GEN_141 = _T_26 ? _io_readData_T_54 : _GEN_140; // @[MemoryFetch.scala 481:35 483:17]
  wire [63:0] _GEN_142 = _T_25 ? _io_readData_T_51 : _GEN_141; // @[MemoryFetch.scala 478:35 480:17]
  wire [63:0] _GEN_143 = _T_24 ? _io_readData_T_48 : _GEN_142; // @[MemoryFetch.scala 475:35 477:17]
  wire [63:0] _GEN_144 = _T_23 ? _io_readData_T_45 : _GEN_143; // @[MemoryFetch.scala 472:35 474:17]
  wire [63:0] _GEN_145 = _T_22 ? _io_readData_T_42 : _GEN_144; // @[MemoryFetch.scala 469:31 471:17]
  ...
  wire [63:0] _GEN_147 = _T_27 ? _io_readData_T_81 : _io_readData_T_84; // @[MemoryFetch.scala 514:35 516:17]
  wire [63:0] _GEN_148 = _T_26 ? _io_readData_T_78 : _GEN_147; // @[MemoryFetch.scala 511:35 513:17]
  wire [63:0] _GEN_149 = _T_25 ? _io_readData_T_75 : _GEN_148; // @[MemoryFetch.scala 508:35 510:17]
  wire [63:0] _GEN_150 = _T_24 ? _io_readData_T_72 : _GEN_149; // @[MemoryFetch.scala 505:35 507:17]
  wire [63:0] _GEN_151 = _T_23 ? _io_readData_T_69 : _GEN_150; // @[MemoryFetch.scala 502:35 504:17]
  wire [63:0] _GEN_152 = _T_22 ? _io_readData_T_66 : _GEN_151; // @[MemoryFetch.scala 499:30 501:17]
  ...
  wire [63:0] _GEN_154 = _T_27 ? _io_readData_T_114 : _io_readData_T_119; // @[MemoryFetch.scala 541:35 543:17]
  wire [63:0] _GEN_155 = _T_26 ? _io_readData_T_109 : _GEN_154; // @[MemoryFetch.scala 538:35 540:17]
  wire [63:0] _GEN_156 = _T_25 ? _io_readData_T_104 : _GEN_155; // @[MemoryFetch.scala 535:35 537:17]
  wire [63:0] _GEN_157 = _T_24 ? _io_readData_T_99 : _GEN_156; // @[MemoryFetch.scala 532:35 534:17]
  wire [63:0] _GEN_158 = _T_23 ? _io_readData_T_94 : _GEN_157; // @[MemoryFetch.scala 529:35 531:17]
  wire [63:0] _GEN_159 = _T_22 ? _io_readData_T_89 : _GEN_158; // @[MemoryFetch.scala 526:32 528:17]
  wire [63:0] _GEN_161 = funct3 == 3'h5 ? _GEN_152 : _GEN_159; // @[MemoryFetch.scala 497:33]
  wire [63:0] _GEN_162 = funct3 == 3'h4 ? _GEN_145 : _GEN_161; // @[MemoryFetch.scala 467:33]
  assign io_readData = io_readEnable ? _GEN_137 : _GEN_162; // @[MemoryFetch.scala 432:23]
  assign io_dccmReq_valid = io_writeEnable | io_readEnable; // @[MemoryFetch.scala 426:42]
  assign io_dccmReq_bits_addrRequest = _io_dccmReq_bits_addrRequest_T[33:2]; // @[MemoryFetch.scala 424:31]
  assign io_dccmReq_bits_dataRequest = {io_dccmReq_bits_dataRequest_hi,io_dccmReq_bits_dataRequest_lo}; // @[MemoryFetch.scala 423:46]
  assign io_dccmReq_bits_activeByteLane = io_writeEnable & io_f3 == 3'h0 ? _GEN_59 : _GEN_110; // @[MemoryFetch.scala 332:45]
  assign io_dccmReq_bits_isWrite = io_writeEnable; // @[MemoryFetch.scala 425:27]
  always @(posedge clock) begin
    if (reset) begin // @[MemoryFetch.scala 306:23]
      offset <= 3'h0; // @[MemoryFetch.scala 306:23]
    end else if (~io_dccmRsp_valid) begin // @[MemoryFetch.scala 310:26]
      offset <= offsetSW; // @[MemoryFetch.scala 313:12]
    end
    if (reset) begin // @[MemoryFetch.scala 307:23]
      funct3 <= 3'h0; // @[MemoryFetch.scala 307:23]
    end else if (~io_dccmRsp_valid) begin // @[MemoryFetch.scala 310:26]
      funct3 <= io_f3; // @[MemoryFetch.scala 311:12]
    end
    `ifndef SYNTHESIS
    `ifdef PRINTF_COND
    ...
    `endif
        if (io_writeEnable & ~reset) begin
          $fwrite(32'h80000002,"%x\n",io_writeData); // @[MemoryFetch.scala 558:11]
        end
    `ifdef PRINTF_COND
      end
    `endif
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [63:0] id_reg_imm; // @[Core.scala 41:27]
  ...
  wire [63:0] _GEN_14 = reset ? 64'h0 : ex_reg_result; // @[Core.scala 351:{31,31} 401:19]
  wire [63:0] _GEN_15 = reset ? $signed(64'sh0) : $signed(ex_reg_wd); // @[Core.scala 352:{32,32} 401:19]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin // @[Core.scala 41:27]
      id_reg_imm <= 64'h0; // @[Core.scala 41:27]
    end else begin
      id_reg_imm <= InstructionDecode_io_immediate; // @[Core.scala 181:14]
    end
    ...
    memAddrDelay <= _GEN_14[31:0]; // @[Core.scala 351:{31,31} 401:19]
    memWdataDelay <= _GEN_15[31:0]; // @[Core.scala 352:{32,32} 401:19]
...
module Tracer(
  ...
  input  [63:0] io_rvfiSInt_0,
  input  [63:0] io_rvfiSInt_1,
  input  [63:0] io_rvfiSInt_2,
  input  [63:0] io_rvfiSInt_3,
  input  [63:0] io_rvfiSInt_4,
  input         io_rvfiBool_0,
...
module Top(
  ...
  wire [63:0] tracer_io_rvfiSInt_0; // @[Top.scala 32:24]
  wire [63:0] tracer_io_rvfiSInt_1; // @[Top.scala 32:24]
  wire [63:0] tracer_io_rvfiSInt_2; // @[Top.scala 32:24]
  wire [63:0] tracer_io_rvfiSInt_3; // @[Top.scala 32:24]
  wire [63:0] tracer_io_rvfiSInt_4; // @[Top.scala 32:24]
  ...
  assign tracer_io_rvfiSInt_0 = {{32{core_io_rvfiSInt_0[31]}},core_io_rvfiSInt_0}; // @[Top.scala 40:19]
  assign tracer_io_rvfiSInt_1 = {{32{core_io_rvfiSInt_1[31]}},core_io_rvfiSInt_1}; // @[Top.scala 40:19]
  assign tracer_io_rvfiSInt_2 = {{32{core_io_rvfiSInt_2[31]}},core_io_rvfiSInt_2}; // @[Top.scala 40:19]
  assign tracer_io_rvfiSInt_3 = {{32{core_io_rvfiSInt_3[31]}},core_io_rvfiSInt_3}; // @[Top.scala 40:19]
  assign tracer_io_rvfiSInt_4 = {{32{core_io_rvfiSInt_4[31]}},core_io_rvfiSInt_4}; // @[Top.scala 40:19]

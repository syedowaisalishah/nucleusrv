...
#endif
#if VM_COVERAGE
  VerilatedCov::write("/home/owais/nucleusrv/test_run_dir/Top_Test/coverage.dat");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 2 : value = dut->io_fcsr; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = "/home/owais/nucleusrv/test_run_dir/Top_Test/Top.vcd";

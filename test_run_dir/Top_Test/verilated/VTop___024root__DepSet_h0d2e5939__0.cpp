...
VL_INLINE_OPT void VTop___024root___sequent__TOP__0(VTop___024root* vlSelf) {
    ...
    VlWide<3>/*95:0*/ __Vtemp_h26d5d7e1__0;
    // Body
    ...
    vlSelf->Top__DOT__imem__DOT__sram__DOT__memory__DOT__addr0_reg 
        = (0x1fffffU & (vlSelf->Top__DOT__core__DOT__Realigner_io_ral_address_o 
                        >> 2U));
    ...
    vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__addr0_reg 
        = vlSelf->Top__DOT__dmem__DOT__sram1_addr_i;
    vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__wmask0_reg 
        = (0xfU & (IData)(vlSelf->Top__DOT__core__DOT__MEM_io_dccmReq_bits_activeByteLane));
    vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__web0_reg 
        = vlSelf->Top__DOT__dmem__DOT__sram2_we_i;
    vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__csb0_reg 
        = vlSelf->Top__DOT__dmem__DOT__sram2_csb_i;
    vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__din0_reg 
        = (IData)(vlSelf->Top__DOT__core__DOT__MEM_io_dccmReq_bits_dataRequest);
    vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__addr0_reg 
        = vlSelf->Top__DOT__dmem__DOT__sram2_addr_i;
    vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__wmask0_reg 
        = (0xfU & ((IData)(vlSelf->Top__DOT__core__DOT__MEM_io_dccmReq_bits_activeByteLane) 
                   >> 4U));
    vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__web0_reg 
        = vlSelf->Top__DOT__dmem__DOT__sram2_we_i;
    vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__csb0_reg 
        = vlSelf->Top__DOT__dmem__DOT__sram2_csb_i;
    vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__din0_reg 
        = (IData)((vlSelf->Top__DOT__core__DOT__MEM_io_dccmReq_bits_dataRequest 
                   >> 0x20U));
    ...
    if (VL_UNLIKELY((((IData)(vlSelf->Top__DOT__core__DOT__stallDelay_3) 
        ...
        VL_FWRITEF(0x80000002U,"ClkCycle: %10#, pc_rdata: %x, pc_wdata: %x, insn: %x, mode: 3, rs1_addr: %2#, rs1_rdata: %x, rs2_addr: %2#, rs2_rdata: %x, rd_addr: %2#, rd_wdata: %x, mem_addr: %x, mem_rdata: %x, mem_wdata: %x\n",
                   ...
                   32,(IData)(((1U == (IData)(vlSelf->Top__DOT__core__DOT__mem_reg_ctl_memToReg))
                                ? vlSelf->Top__DOT__core__DOT__MEM_io_readData
                                : vlSelf->Top__DOT__core__DOT___GEN_6)),
                   32,vlSelf->Top__DOT__core__DOT__memAddrDelay,
                   32,(IData)(vlSelf->Top__DOT__core__DOT__MEM_io_readData),
                   32,vlSelf->Top__DOT__core__DOT__memWdataDelay);
    }
    if (VL_UNLIKELY(((IData)(vlSelf->Top__DOT__core__DOT__ex_reg_ctl_memWrite) 
                     & (~ (IData)(vlSelf->reset))))) {
        VL_FWRITEF(0x80000002U,"%x\n",64,vlSelf->Top__DOT__core__DOT__ex_reg_wd);
    }
    vlSelf->Top__DOT__imem__DOT__sram__DOT__wdata_o = 0U;
    vlSelf->Top__DOT__imem__DOT__sram__DOT__we_o = 1U;
    vlSelf->Top__DOT__imem__DOT__sram__DOT__csb = vlSelf->reset;
    vlSelf->Top__DOT__dmem__DOT__sram1__DOT__we_o = 
        ((IData)(vlSelf->reset) | (IData)(vlSelf->Top__DOT__dmem__DOT__sram2_we_i));
    vlSelf->Top__DOT__dmem__DOT__sram2__DOT__we_o = 
        ((IData)(vlSelf->reset) | (IData)(vlSelf->Top__DOT__dmem__DOT__sram2_we_i));
    vlSelf->Top__DOT__dmem__DOT__sram1__DOT__csb = 
        ((IData)(vlSelf->reset) | (IData)(vlSelf->Top__DOT__dmem__DOT__sram2_csb_i));
    vlSelf->Top__DOT__dmem__DOT__sram2__DOT__csb = 
        ((IData)(vlSelf->reset) | (IData)(vlSelf->Top__DOT__dmem__DOT__sram2_csb_i));
    vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__csr__DOT__csrRegFile__DOT__MHARTID_REG = 0U;
    vlSelf->Top__DOT__core__DOT__id_reg_imm = (IData)(
                                                      ((IData)(vlSelf->reset)
                                                        ? 0ULL
                                                        : 
                                                       (((QData)((IData)(
                                                                         vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT___io_immediate_T_9[1U])) 
                                                         << 0x20U) 
                                                        | (QData)((IData)(
                                                                          vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT___io_immediate_T_9[0U])))));
    vlSelf->Top__DOT__imem__DOT__validReg = (1U & (~ (IData)(vlSelf->reset)));
    ...
    if (vlSelf->reset) {
        vlSelf->Top__DOT__imem__DOT__sram__DOT__rvalid = 0U;
        vlSelf->Top__DOT__imem__DOT__sram__DOT__wmask_o = 0U;
        vlSelf->Top__DOT__dmem__DOT__sram1__DOT__addr_o = 0U;
        vlSelf->Top__DOT__dmem__DOT__sram2__DOT__addr_o = 0U;
        vlSelf->Top__DOT__imem__DOT__sram__DOT__addr_o = 0U;
        vlSelf->Top__DOT__dmem__DOT__sram1__DOT__wmask_o = 0U;
        vlSelf->Top__DOT__dmem__DOT__sram2__DOT__wmask_o = 0U;
        vlSelf->Top__DOT__dmem__DOT__sram1__DOT__wdata_o = 0U;
        vlSelf->Top__DOT__dmem__DOT__sram2__DOT__wdata_o = 0U;
        vlSelf->Top__DOT__dmem__DOT__sram1__DOT__rvalid = 0U;
        vlSelf->Top__DOT__dmem__DOT__sram2__DOT__rvalid = 0U;
        __Vdly__Top__DOT__core__DOT__Realigner__DOT__stateReg = 0U;
    } else {
        if (vlSelf->reset) {
            vlSelf->Top__DOT__imem__DOT__sram__DOT__rvalid = 0U;
        } else if ((1U & (~ (IData)(vlSelf->reset)))) {
            vlSelf->Top__DOT__imem__DOT__sram__DOT__rvalid = 1U;
        }
        vlSelf->Top__DOT__imem__DOT__sram__DOT__wmask_o = 0xfU;
        vlSelf->Top__DOT__dmem__DOT__sram1__DOT__addr_o 
            = vlSelf->Top__DOT__dmem__DOT__sram1_addr_i;
        vlSelf->Top__DOT__dmem__DOT__sram2__DOT__addr_o 
            = vlSelf->Top__DOT__dmem__DOT__sram2_addr_i;
        vlSelf->Top__DOT__imem__DOT__sram__DOT__addr_o 
            = (0x1fffffU & (vlSelf->Top__DOT__core__DOT__Realigner_io_ral_address_o 
                            >> 2U));
        vlSelf->Top__DOT__dmem__DOT__sram1__DOT__wmask_o 
            = (0xfU & (IData)(vlSelf->Top__DOT__core__DOT__MEM_io_dccmReq_bits_activeByteLane));
        vlSelf->Top__DOT__dmem__DOT__sram2__DOT__wmask_o 
            = (0xfU & ((IData)(vlSelf->Top__DOT__core__DOT__MEM_io_dccmReq_bits_activeByteLane) 
                       >> 4U));
        vlSelf->Top__DOT__dmem__DOT__sram1__DOT__wdata_o 
            = (IData)(vlSelf->Top__DOT__core__DOT__MEM_io_dccmReq_bits_dataRequest);
        vlSelf->Top__DOT__dmem__DOT__sram2__DOT__wdata_o 
            = (IData)((vlSelf->Top__DOT__core__DOT__MEM_io_dccmReq_bits_dataRequest 
                       >> 0x20U));
        if (vlSelf->Top__DOT__dmem__DOT__sram2_we_i) {
            if (((~ (IData)(vlSelf->Top__DOT__dmem__DOT__sram2_csb_i)) 
                 & (IData)(vlSelf->Top__DOT__dmem__DOT__sram2_we_i))) {
                vlSelf->Top__DOT__dmem__DOT__sram1__DOT__rvalid = 1U;
                vlSelf->Top__DOT__dmem__DOT__sram2__DOT__rvalid = 1U;
            }
        } else {
            vlSelf->Top__DOT__dmem__DOT__sram1__DOT__rvalid = 0U;
            vlSelf->Top__DOT__dmem__DOT__sram2__DOT__rvalid = 0U;
    ...
    vlSelf->Top__DOT__core__DOT__memWdataDelay = (IData)(
                                                         ((IData)(vlSelf->reset)
                                                           ? 0ULL
                                                           : vlSelf->Top__DOT__core__DOT__ex_reg_wd));
    vlSelf->Top__DOT__core__DOT__memAddrDelay = (IData)(
                                                        ((IData)(vlSelf->reset)
                                                          ? 0ULL
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->Top__DOT__core__DOT__mem_reg_result = 0ULL;
        ...
        vlSelf->Top__DOT__core__DOT__Realigner__DOT__lhw_reg 
            = (0xffffU & (IData)((vlSelf->Top__DOT__core__DOT__InstructionFetch_io_instruction 
                                  >> 0x10U)));
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->Top__DOT__core__DOT__id_reg_ctl_aluOp 
            = ((0x33U == (0x7fU & vlSelf->Top__DOT__core__DOT__if_reg_ins))
                ? 2U : ((0x3bU == (0x7fU & vlSelf->Top__DOT__core__DOT__if_reg_ins))
        ...
        vlSelf->Top__DOT__core__DOT__id_reg_f3 = (7U 
                                                  & (vlSelf->Top__DOT__core__DOT__if_reg_ins 
                                                     >> 0xcU));
        vlSelf->Top__DOT__core__DOT__id_reg_f7 = ((
                                                   (0x33U 
                                                    == 
                                                    (0x7fU 
                                                     & vlSelf->Top__DOT__core__DOT__if_reg_ins)) 
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_29 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_27 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_28 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_30 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_31 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_26 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_21 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_19 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_20 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_14 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_22 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_23 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_24 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_25 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_15 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_16 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_17 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_18 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_9 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_7 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_11 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_2 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_10 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_1 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_5 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_13 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_6 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_8 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_0 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_3 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_12 = 0ULL;
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers__DOT__reg_4 = 0ULL;
    } else {
                                                      ...
                                                      ((0x63U 
                                                       ...
                                                       ((0x37U 
                                                        ...
                                                        (0x17U 
                                                         ...
                                                         (0x7fU 
                                                          & vlSelf->Top__DOT__core__DOT__if_reg_ins))))))))))));
        if (((IData)(vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__registers_io_writeEnable) 
    ...
    if (vlSelf->reset) {
        ...
        if ((1U & (~ (IData)(vlSelf->Top__DOT__dmem__DOT__validReg)))) {
            ...
            vlSelf->Top__DOT__core__DOT__MEM__DOT__offset 
                = (7U & (IData)(vlSelf->Top__DOT__core__DOT__ex_reg_result));
        }
    }
    vlSelf->Top__DOT__dmem__DOT__validReg = (1U & (~ (IData)(vlSelf->reset)));
    ...
    vlSelf->Top__DOT__core__DOT__rsDataDelay_1_0 = (IData)(vlSelf->Top__DOT__core__DOT__id_reg_rd2);
    vlSelf->Top__DOT__core__DOT__rsDataDelay_0_0 = (IData)(vlSelf->Top__DOT__core__DOT__id_reg_rd1);
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->Top__DOT__core__DOT__ex_reg_wd = 0ULL;
        vlSelf->Top__DOT__core__DOT__ex_reg_result = 0ULL;
        ...
        vlSelf->Top__DOT__core__DOT__ex_reg_result 
            = (((QData)((IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[1U])) 
                << 0x20U) | (QData)((IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[0U])));
    ...
    if (vlSelf->reset) {
        vlSelf->Top__DOT__core__DOT__id_reg_rd1 = 0ULL;
        vlSelf->Top__DOT__core__DOT__id_reg_rd2 = 0ULL;
                                                        ...
                                                        ((0x17U 
                                                         ...
                                                         ((0x6fU 
                                                          ...
                                                          ((0x67U 
                                                            ...
                                                            ? 2U
                                                            : 0U)))))))))))));
        vlSelf->Top__DOT__core__DOT__id_reg_wra = (0x1fU 
                                                   & (vlSelf->Top__DOT__core__DOT__if_reg_ins 
                                                      >> 7U));
        if (vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__hdu_io_if_reg_write) {
    ...
    vlSelf->Top__DOT__core__DOT__insDelay_0 = (IData)(vlSelf->Top__DOT__core__DOT__InstructionFetch_io_instruction);
    ...
    vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__csrController__DOT__csrHazard_DecEx 
        = (((IData)(Top__DOT__core__DOT__InstructionDecode__DOT__csrController__DOT___hazard_DecEx_T_4) 
            & (IData)(vlSelf->Top__DOT__core__DOT__id_reg_is_csr)) 
           & (IData)(Top__DOT__core__DOT__InstructionDecode__DOT__csrController__DOT___hazard_DecEx_T_7));
    VL_EXTEND_WQ(96,64, __Vtemp_h26d5d7e1__0, vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__immediate_io_out);
    if (((0x37U == (0x7fU & vlSelf->Top__DOT__core__DOT__if_reg_ins)) 
         | (0x17U == (0x7fU & vlSelf->Top__DOT__core__DOT__if_reg_ins)))) {
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT___io_immediate_T_9[0U] 
        ...
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT___io_immediate_T_9[1U] 
            = (IData)((vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__immediate_io_out 
                       >> 0x20U));
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT___io_immediate_T_9[2U] 
            = ((vlSelf->Top__DOT__core__DOT__if_reg_ins 
                >> 0x1fU) ? 0xffffffffU : 0U);
    } else {
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT___io_immediate_T_9[0U] 
            = __Vtemp_h26d5d7e1__0[0U];
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT___io_immediate_T_9[1U] 
            = __Vtemp_h26d5d7e1__0[1U];
        vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT___io_immediate_T_9[2U] 
            = __Vtemp_h26d5d7e1__0[2U];
    }
...
VL_INLINE_OPT void VTop___024root___sequent__TOP__1(VTop___024root* vlSelf) {
    ...
    if ((1U & ((~ (IData)(vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__csb0_reg)) 
               & (~ (IData)(vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__web0_reg))))) {
        if ((1U & (IData)(vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__wmask0_reg))) {
            vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__mem[vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__addr0_reg] 
                = ((0xffffff00U & vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__mem
                    [vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__addr0_reg]) 
                   | (0xffU & vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__din0_reg));
        }
        if ((2U & (IData)(vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__wmask0_reg))) {
            vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__mem[vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__addr0_reg] 
                = ((0xffff00ffU & vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__mem
                    [vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__addr0_reg]) 
                   | (0xff00U & vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__din0_reg));
        }
        if ((4U & (IData)(vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__wmask0_reg))) {
            vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__mem[vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__addr0_reg] 
                = ((0xff00ffffU & vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__mem
                    [vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__addr0_reg]) 
                   | (0xff0000U & vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__din0_reg));
        }
        if ((8U & (IData)(vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__wmask0_reg))) {
            vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__mem[vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__addr0_reg] 
                = ((0xffffffU & vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__mem
                    [vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__addr0_reg]) 
                   | (0xff000000U & vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__din0_reg));
        }
    }
    if ((1U & ((~ (IData)(vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__csb0_reg)) 
               & (~ (IData)(vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__web0_reg))))) {
        if ((1U & (IData)(vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__wmask0_reg))) {
            vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__mem[vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__addr0_reg] 
                = ((0xffffff00U & vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__mem
                    [vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__addr0_reg]) 
                   | (0xffU & vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__din0_reg));
        }
        if ((2U & (IData)(vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__wmask0_reg))) {
            vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__mem[vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__addr0_reg] 
                = ((0xffff00ffU & vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__mem
                    [vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__addr0_reg]) 
                   | (0xff00U & vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__din0_reg));
        }
        if ((4U & (IData)(vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__wmask0_reg))) {
            vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__mem[vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__addr0_reg] 
                = ((0xff00ffffU & vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__mem
                    [vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__addr0_reg]) 
                   | (0xff0000U & vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__din0_reg));
        }
        if ((8U & (IData)(vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__wmask0_reg))) {
            vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__mem[vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__addr0_reg] 
                = ((0xffffffU & vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__mem
                    [vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__addr0_reg]) 
                   | (0xff000000U & vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__din0_reg));
        }
    }
    ...
    if (((~ (IData)(vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__csb0_reg)) 
         & (IData)(vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__web0_reg))) {
        vlSelf->Top__DOT__dmem__DOT__sram1_rdata_o 
            = vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__mem
            [vlSelf->Top__DOT__dmem__DOT__sram1__DOT__memory__DOT__addr0_reg];
    }
    if (((~ (IData)(vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__csb0_reg)) 
         & (IData)(vlSelf->Top__DOT__dmem__DOT__sram2__DOT__memory__DOT__web0_reg))) {
        vlSelf->Top__DOT__dmem__DOT__sram2_rdata_o 
...
VL_INLINE_OPT void VTop___024root___multiclk__TOP__0(VTop___024root* vlSelf) {
    ...
    VlWide<4>/*127:0*/ __Vtemp_h990f081b__0;
    VlWide<4>/*127:0*/ __Vtemp_h98b90043__0;
    VlWide<4>/*127:0*/ __Vtemp_h984726dd__0;
    VlWide<4>/*127:0*/ __Vtemp_h98741d4d__0;
    VlWide<4>/*127:0*/ __Vtemp_h8314621f__0;
    VlWide<4>/*127:0*/ __Vtemp_h824fa29c__0;
    VlWide<4>/*127:0*/ __Vtemp_hfc1d04cb__0;
    VlWide<4>/*127:0*/ __Vtemp_ha73c27d9__0;
    VlWide<4>/*127:0*/ __Vtemp_ha83e83dd__0;
    // Body
    ...
    vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input2 
        = ((IData)(vlSelf->Top__DOT__core__DOT__id_reg_ctl_aluSrc)
            ? ((0U == (IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__ForwardingUnit_io_forwardB))
                ? vlSelf->Top__DOT__core__DOT__id_reg_rd2
                : vlSelf->Top__DOT__core__DOT__Execute__DOT___inputMux2_T_4)
            : (QData)((IData)(vlSelf->Top__DOT__core__DOT__id_reg_imm)));
    ...
    vlSelf->Top__DOT__core__DOT__InstructionDecode__DOT__bu_io_rd2 
        = (((0x1fU & (vlSelf->Top__DOT__core__DOT__if_reg_ins 
            ...
            : (((0x1fU & (vlSelf->Top__DOT__core__DOT__if_reg_ins 
                ...
                ? vlSelf->Top__DOT__core__DOT__Execute_io_wb_result
                : vlSelf->Top__DOT__core__DOT__InstructionDecode_io_readData2));
    VL_EXTEND_WQ(127,64, __Vtemp_h990f081b__0, (vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input1 
                                                & vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input2));
    VL_EXTEND_WQ(127,64, __Vtemp_h98b90043__0, (vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input1 
                                                | vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input2));
    VL_EXTEND_WQ(127,64, __Vtemp_h984726dd__0, (vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input1 
                                                + vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input2));
    VL_EXTEND_WQ(127,64, __Vtemp_h98741d4d__0, (vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input1 
                                                - vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input2));
    VL_EXTEND_WI(127,1, __Vtemp_h8314621f__0, VL_LTS_IQQ(64, vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input1, vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input2));
    VL_EXTEND_WI(127,1, __Vtemp_h824fa29c__0, (vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input1 
                                               < vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input2));
    VL_EXTEND_WQ(127,64, __Vtemp_hfc1d04cb__0, vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input1);
    VL_SHIFTL_WWI(127,127,6, __Vtemp_ha73c27d9__0, __Vtemp_hfc1d04cb__0, 
                  (0x3fU & (IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__alu_io_input2)));
    VL_EXTEND_WQ(127,64, __Vtemp_ha83e83dd__0, ((7U 
    ...
    if ((0U == (IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__aluCtl_io_out))) {
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[0U] 
            = __Vtemp_h990f081b__0[0U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[1U] 
            = __Vtemp_h990f081b__0[1U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[2U] 
            = __Vtemp_h990f081b__0[2U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[3U] 
            = (0x7fffffffU & __Vtemp_h990f081b__0[3U]);
    } else if ((1U == (IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__aluCtl_io_out))) {
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[0U] 
            = __Vtemp_h98b90043__0[0U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[1U] 
            = __Vtemp_h98b90043__0[1U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[2U] 
            = __Vtemp_h98b90043__0[2U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[3U] 
            = (0x7fffffffU & __Vtemp_h98b90043__0[3U]);
    } else if ((2U == (IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__aluCtl_io_out))) {
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[0U] 
            = __Vtemp_h984726dd__0[0U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[1U] 
            = __Vtemp_h984726dd__0[1U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[2U] 
            = __Vtemp_h984726dd__0[2U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[3U] 
            = (0x7fffffffU & __Vtemp_h984726dd__0[3U]);
    } else if ((3U == (IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__aluCtl_io_out))) {
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[0U] 
            = __Vtemp_h98741d4d__0[0U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[1U] 
            = __Vtemp_h98741d4d__0[1U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[2U] 
            = __Vtemp_h98741d4d__0[2U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[3U] 
            = (0x7fffffffU & __Vtemp_h98741d4d__0[3U]);
    } else if ((4U == (IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__aluCtl_io_out))) {
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[0U] 
            = __Vtemp_h8314621f__0[0U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[1U] 
            = __Vtemp_h8314621f__0[1U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[2U] 
            = __Vtemp_h8314621f__0[2U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[3U] 
            = (0x7fffffffU & __Vtemp_h8314621f__0[3U]);
    } else if ((5U == (IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__aluCtl_io_out))) {
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[0U] 
            = __Vtemp_h824fa29c__0[0U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[1U] 
            = __Vtemp_h824fa29c__0[1U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[2U] 
            = __Vtemp_h824fa29c__0[2U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[3U] 
            = (0x7fffffffU & __Vtemp_h824fa29c__0[3U]);
    } else if ((6U == (IData)(vlSelf->Top__DOT__core__DOT__Execute__DOT__aluCtl_io_out))) {
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[0U] 
            = __Vtemp_ha73c27d9__0[0U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[1U] 
            = __Vtemp_ha73c27d9__0[1U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[2U] 
            = __Vtemp_ha73c27d9__0[2U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[3U] 
            = (0x7fffffffU & __Vtemp_ha73c27d9__0[3U]);
    } else {
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[0U] 
            = __Vtemp_ha83e83dd__0[0U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[1U] 
            = __Vtemp_ha83e83dd__0[1U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[2U] 
            = __Vtemp_ha83e83dd__0[2U];
        vlSelf->Top__DOT__core__DOT__Execute__DOT__alu__DOT___io_result_T_38[3U] 
            = (0x7fffffffU & __Vtemp_ha83e83dd__0[3U]);
    }

...
// wdata(0) := io.writeData(7,0).asSInt
// wdata(1) := io.writeData(15,8).asSInt
// wdata(2) := io.writeData(23,16).asSInt
// wdata(3) := io.writeData(31,24).asSInt
// wdata(4) := io.writeData(39,32).asSInt
// wdata(5) := io.writeData(47,40).asSInt
// wdata(6) := io.writeData(55,48).asSInt
// wdata(7) := io.writeData(63,56).asSInt
...
//     wdata(0) := io.writeData(15,8).asSInt
//     wdata(1) := io.writeData(7,0).asSInt
//     wdata(2) := io.writeData(23,16).asSInt
//     wdata(3) := io.writeData(31,24).asSInt
...
//     wdata(0) := io.writeData(15,8).asSInt
//     wdata(1) := io.writeData(23,16).asSInt
//     wdata(2) := io.writeData(7,0).asSInt
//     wdata(3) := io.writeData(31,24).asSInt
//     io.dccmReq.bits.activeByteLane := "b00000100".U
//   }.elsewhen(offsetSW === 3.U){
//     wdata(0) := io.writeData(15,8).asSInt
//     wdata(1) := io.writeData(23,16).asSInt
//     wdata(2) := io.writeData(31,24).asSInt
//     wdata(3) := io.writeData(7,0).asSInt
//     io.dccmReq.bits.activeByteLane := "b00001000".U
//   }.elsewhen(offsetSW === 4.U){
//     wdata(0) := io.writeData(15,8).asSInt
//     wdata(1) := io.writeData(23,16).asSInt
//     wdata(2) := io.writeData(31,24).asSInt
//     wdata(3) := io.writeData(39,32).asSInt
//     wdata(4) := io.writeData(7,0).asSInt
//     io.dccmReq.bits.activeByteLane := "b00010000".U
//   }.elsewhen(offsetSW === 5.U){
//     wdata(0) := io.writeData(15,8).asSInt
//     wdata(1) := io.writeData(23,16).asSInt
//     wdata(2) := io.writeData(31,24).asSInt
//     wdata(3) := io.writeData(47,40).asSInt
//     wdata(5) := io.writeData(7,0).asSInt
//     io.dccmReq.bits.activeByteLane := "b00100000".U
//   }.elsewhen(offsetSW === 6.U){
//     wdata(0) := io.writeData(15,8).asSInt
//     wdata(1) := io.writeData(23,16).asSInt
//     wdata(2) := io.writeData(31,24).asSInt
//     wdata(3) := io.writeData(55,48).asSInt
//     wdata(6) := io.writeData(7,0).asSInt
//     io.dccmReq.bits.activeByteLane := "b01000000".U
//   }.elsewhen(offsetSW === 7.U){
//     wdata(0) := io.writeData(15,8).asSInt
//     wdata(1) := io.writeData(23,16).asSInt
//     wdata(2) := io.writeData(31,24).asSInt
//     wdata(3) := io.writeData(63,56).asSInt
//     wdata(7) := io.writeData(7,0).asSInt
